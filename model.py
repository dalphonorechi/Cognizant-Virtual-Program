...
def create_target_and_predictors(
        data: pd.DataFrame = None, target: str = "estimated_stock_pct"
):
    """
    ...
    y = data[target]
    print('Feature Vector and Target Matrix Created.')
    return X, y
...
if __name__ == '__main__':
    # When running the script give a path to the data.
	# e.g python module.py "/path/to/csv/"
	path = sys.argv[1]
	if not path:
